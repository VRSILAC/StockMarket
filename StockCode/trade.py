...
def parser():
    ...
    parser.add_argument("--model", default='SO', type=str,
    ...
    parser.add_argument("--dataset", default='/home/carmelo/Documents/StockMarket/StockData/stocks_100d.obj', type=str,

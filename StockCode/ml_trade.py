...
stocks = load_stocks('spy.obj')
# stocks = stocks[::100]
stocks = make_labels_percent_gain(stocks, 1, 'ge', label_pg_crit=0.01)
...
swing_(stocks, day_trade=True, model_type=model_type, model=model)
